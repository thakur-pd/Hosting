...
BOT_TOKEN = "8338940224:AAGDfVbmUxBkfBXRsH6vkeS0lvLQVa2G0jw"

# Load thresholds
CPU_THRESHOLD = float(os.environ.get("CPU_THRESHOLD", "10.0"))
MEMORY_THRESHOLD = float(os.environ.get("MEMORY_THRESHOLD", "10.0"))
MAX_RUNNING_PROCESSES = int(os.environ.get("MAX_RUNNING_PROCESSES", "100"))
...
def updates_handler(message):
    bot.send_message(message.chat.id, "📢 Join our channel: t.me/Backup14700")

@bot.message_handler(func=lambda m: m.text == "📞 Contact Owner")
def contact_handler(message):
    bot.send_message(message.chat.id, "📞 Contact: @krishna7824")
